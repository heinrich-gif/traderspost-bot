...
REL_VOL_MIN = float(os.getenv("PENNY_REL_VOL_MIN", "3"))      # Relative Volume >= 3 (Finviz-Filter)
AVG_VOL_MIN = int(os.getenv("PENNY_AVG_VOL_MIN", "1000000"))   # Avg Volume >= 1M (Finviz-Filter)
